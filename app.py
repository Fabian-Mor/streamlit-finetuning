...
plot_options = ["PCA", "Training", "Compare", "Plane"]
...
if lr:
    try:
        if plot_type == "PCA":
            with open(f"results/{dataset}/pca/{lr}.pkl", "rb") as f:
                result = pkl.load(f)
            ...
            with open(f'results/{dataset}/{lr}.pkl', 'rb') as f:
                result = pkl.load(f)
            ...
            with open(f'results/{dataset}/opt_inter/{lr}.pkl', 'rb') as f:
                result = pkl.load(f)
            ...
            with open(f'results/{dataset}/triangle/{lr}.pkl', 'rb') as f:
                result = pkl.load(f)
